...
const SINGLE_SYSTEM_PROMPT =
  ...
  "(5) LENGTH AND FORM — CRITICAL: Count the words in the CONDENSED correct answer from step (1), not the original. Every distractor must be within ±2 words of that count. Mirror the condensed answer's grammatical form exactly: if it's a noun phrase, each distractor is a noun phrase; if it's a number, each distractor is a number; if it's a full sentence, each distractor is a full sentence; if it uses technical terminology, each distractor uses equally specific technical terminology. A distractor that is noticeably shorter, vaguer, or less specific than the condensed answer is a failure.\n" +
...
const BATCH_SYSTEM_PROMPT =
  ...
  "(6) LENGTH AND FORM — CRITICAL: Count the words in the CONDENSED correct answer from step (1), not the original. Every distractor must be within ±2 words of that count. Mirror the condensed answer's grammatical form exactly: if it's a noun phrase, each distractor is a noun phrase; if it's a number, each distractor is a number; if it's a full sentence, each distractor is a full sentence; if it uses technical terminology, each distractor uses equally specific technical terminology. A distractor that is noticeably shorter, vaguer, or less specific than the condensed answer is a failure.\n" +
